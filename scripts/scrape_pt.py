...
def main():
    ...
    csv_path = os.path.join(root_dir, 'unitex-pt-br/data/mirror/DELAS.csv')
    db_path = os.path.join(root_dir, 'palabras.db')
    log_path = os.path.join(root_dir, 'failed_scrapes.log')
